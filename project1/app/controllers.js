angular.module("vikingApp").controller("homeController", function($scope) {
    ...
    $scope.backgroundImage = 'http://srdesigner.io/_assets/discoverShip.png';
    ...
    $scope.selectedItemChanged = function(){
        ...
        switch( $scope.chosen.choice){
            case "Deck 9":
                $scope.myBg = 'http://srdesigner.io/_assets/deck9.png';
                $scope.code = 'pJaCrB6mDyI';
                break;
            case "Deck 8":
                $scope.myBg = 'http://srdesigner.io/_assets/deck8.png';
                $scope.code = 'n7vqlKSAwIs';
                break;
            case "Deck 7":
                $scope.myBg = 'http://srdesigner.io/_assets/deck7.png';
                $scope.code = 'dGz5V3dwFbQ';
                break;
            case "Deck 6":
                $scope.myBg = 'http://srdesigner.io/_assets/deck6.png';
                $scope.code = 'SYqv2UOP_fM';
                break;
            case "Deck 5":
                $scope.myBg = 'http://srdesigner.io/_assets/deck5.png';
                $scope.code = 'wAHzTLiaSDQ';
                break;
            case "Deck 4":
                $scope.myBg = 'http://srdesigner.io/_assets/deck4.png';
                $scope.code = '8QZrk1-Ty-E';
                break;
            case "Deck 3":
                $scope.myBg = 'http://srdesigner.io/_assets/deck3.png';
                $scope.code = '4ulB5HEYNT4';
                break;
            case "Deck 2":
                $scope.myBg = 'http://srdesigner.io/_assets/deck2.png';
                $scope.code = 'wZylMc_yZVE';
                break;
            case "Deck 1":
                $scope.myBg = 'http://srdesigner.io/_assets/deck1.png';
                $scope.code = 'o5nTQXv3Zfw';
                break;
            case "Deck A":
                $scope.myBg = 'http://srdesigner.io/_assets/deckA.png';
